...
const PlainContemplationNoteForm = () => {
  ...
  const mutation = useMutation({
    ...
    onSettled(data, error) {
      toast({
        title: error ? '묵상노트 저장 실패' : '묵상노트 저장 성공',
        description: error ? error.message : '묵상노트가 저장되었습니다',
      })
...
export default PlainContemplationNoteForm;
