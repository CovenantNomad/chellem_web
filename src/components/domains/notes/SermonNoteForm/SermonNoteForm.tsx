...
const SermonNoteForm = ({ viewOptions, script, book, chapters, serviceType, title, date }: SermonNoteFormProps) => {
  ...
  const { isLoading, isFetching, data } = useQuery({
    queryKey: ['getExistingNote', date, 'SERMON'],
    queryFn: () => getExistingNote({date, type: 'SERMON'}),
